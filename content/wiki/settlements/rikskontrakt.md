---
title: "Rikskontrakt"
description: "Tre veckokontrakt per settlement, Rikskistor i The Capitol och Coinsbelöningar för gemensamma leveranser."
...
infobox:
  ...
  belöning: "Ca 3-5 miljoner Coins"
relatedArticles:
  - category: "settlements"
    article: "policies"
    title: "Policies"
...
Rikskontrakt är gemensamma veckouppdrag för settlements. Varje settlement får **tre kontrakt per kontraktsvecka**. The Capitol får också tre Rikskontrakt.

Kontrakten innehåller stora leveranser av resurser från flera produktionskategorier och belönar settlementet med ungefär **3 till 5 miljoner Coins** beroende på kontraktets svårighet.
...
## Tre kontrakt, ett aktivt åt gången

Alla tre kontrakt kan slutföras under samma vecka, men settlementet kan bara ha **ett ACTIVE-kontrakt åt gången**.
