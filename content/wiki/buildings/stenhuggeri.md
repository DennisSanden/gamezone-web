...
Först då blir **Stenhuggeri** färdigställd och dess bonus eller funktion aktiveras.
...
Bonusen pausas under flytten. Placera därefter den nya byggytan med `/building place stenhuggeri` och färdigställ den som vanligt.
...
Den gamla byggnaden måste fortfarande uppfylla kraven för att kunna återaktiveras. Den gamla konstruktionen behöver inte rivas när flytten är klar, men räknas inte längre som settlementets officiella Stenhuggeri.
