...
import kingsLedgerImage from "../wiki/relics/assets/the-kings-ledger.png";
...
const relicArtwork: Record<string, RelicArtwork> = {
    ...
    "GZR-0027": { src: kingsLedgerImage.src, caption: "WRITTEN BOOK" },
...
const publicBeforeDiscovery = new Set([
    ...
    "GZR-0023", "GZR-0024",
    "GZR-0025", "GZR-0027", "GZR-0028", "GZR-0029", "GZR-0030", "GZR-0033", "GZR-0034",
...
function relicWikiHref(relic: Relic) {
    ...
    if (relic.serial === "GZR-0024") return "/wiki/relics/sunpiercer";
    ...
    if (relic.serial === "GZR-0027") return "/wiki/relics/the-kings-ledger";
